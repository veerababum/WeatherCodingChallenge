...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        /// set Google api key to access authocompleteUI and googlePlaces api
    ...
    private func customizeNavigationBarAppearance() {
        UINavigationBar.appearance().barTintColor = UIColor(displayP3Red: 255/255, green: 102/255, blue: 0/255, alpha: 1.0)
